...
import validationSchema from './shareHolderSchema';
...
function ShareHolderFormComponent({ onFormSubmit, initData }: Props) {
  const List = useContext(MasterContext.DropdownContext);
  const cpDetails = initData?.connectedPartiesDetails[0]; // remove [0] filter using connectedPartyType: 'Shareholders / Partners'
  ...
  const createWorkItemStructure = (data:any) => {
    const obj = {
      ...
      refMapper: '',
      taxMapper: '',
      connectedPartyType: 'Shareholders / Partners',
      connectedPartyCIF: '',
              ...
              <div className={styles.gridContainer}>
                ...
                <div>
                  <FormControl
                    ...
                    list={List['COUNTRY-MAST']}
                    onChange={(val: any) => handleChange(val[0], 'customerInformation.countryOfRecidence', formik)}
                    isInvalid={Boolean(
                ...
                <div>
                  <FormControl
                    ...
                    name="customerInformation.legalEntityType"
                    list={List['COMP-LEG-ENT-TYP']}
                    onChange={(val: string[]) => handleChange(val[0], 'customerInformation.legalEntityType', formik)}
                    isInvalid={Boolean(
                      formik.errors.customerInformation?.legalEntityType
                      && formik.touched.customerInformation?.legalEntityType,
                    )}
                  />
                </div>
                <div>
                  <FormControl
                    ...
                    name="customerInformation.letalEntityCategory"
                    list={List['LEG-ENT-CAT']}
                    onChange={(val: string[]) => handleChange(val[0], 'customerInformation.letalEntityCategory', formik)}
                    isInvalid={Boolean(
                      formik.errors.customerInformation?.letalEntityCategory
                      && formik.touched.customerInformation?.letalEntityCategory,
                    )}
                  />
                </div>
                <div>
                  <FormControl
                    ...
                    name="customerInformation.shareholdingAmount"
                    onChange={(val: string) => handleChange(val, 'customerInformation.shareholdingAmount', formik)}
                    isInvalid={Boolean(
                      formik.errors.customerInformation?.shareholdingAmount
                      && formik.touched.customerInformation?.shareholdingAmount,
                    )}
                  />
                </div>
                <div>
                  <FormControl
                    control="fastselect"
                    label="Shareholding %"
                    name="customerInformation.shareholdingPercentage"
                    list={List['PAT-AT-AED']}
                    onChange={(val: string[]) => handleChange(val[0], 'customerInformation.shareholdingPercentage', formik)}
                    isInvalid={Boolean(
                      formik.errors.customerInformation?.shareholdingPercentage
                      && formik.touched.customerInformation?.shareholdingPercentage,
                    )}
                  />
                </div>
                <div>
                  <FormControl
                    ...
                    name="customerInformation.typeOfOwnership"
                    onChange={(val: string) => handleChange(val, 'customerInformation.typeOfOwnership', formik)}
                    isInvalid={Boolean(
                      formik.errors.customerInformation?.typeOfOwnership
                      && formik.touched.customerInformation?.typeOfOwnership,
                    )}
                  />
                </div>
                <div>
                  <FormControl
                    ...
                    name="customerInformation.ownershipStatus"
                    onChange={(val: string) => handleChange(val, 'customerInformation.ownershipStatus', formik)}
                    isInvalid={Boolean(
                      formik.errors.customerInformation?.ownershipStatus
                      && formik.touched.customerInformation?.ownershipStatus,
                    )}
                  />
                </div>
                <div>
...
export default ShareHolderFormComponent;
