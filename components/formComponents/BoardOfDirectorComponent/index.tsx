...
function BoardOfDirector({ onFormSubmit, initData }:Props) {
  const [primaryPNCountrycode, setPrimaryPNCountrycode] = useState('');
  ...
  const createWorkItemStructure = (data:any) => {
    const obj = {
      ...
      refMapper: '',
      taxMapper: '',
      connectedPartyType: 'Board of Director',
      connectedPartyCIF: '',
              ...
              <div className={styles.gridContainer}>
                ...
                <div>
                  <FormControl
                    ...
                    name="customerInformation.primaryMobileNumber"
                    ...
                    onBlur={() => { console.log('primaryphno onblur'); }}
                    onChange={(val: any) => handleChange(val, 'customerInformation.primaryMobileNumber', formik)}
                    onChangeSelect={(val: string[]) => {
                      setPrimaryPNCountrycode(val[0]);
                      console.log(primaryPNCountrycode);
                    }}
                    onKeyUp={() => {}}
                    pattern={/[\d.]/g}
