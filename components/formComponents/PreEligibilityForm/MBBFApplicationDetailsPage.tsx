...
function MBBFApplicationDetailsPage({ initialVal, onFormSubmit }:Props) {
    ...
    <>
      <div className={styles.RegContainer}>
        <div className={styles.regCard}>
          <Card>
            <div className={styles.FabHeading}>MBBF Loan Details</div>
                ...
                <Form autoComplete="off" onSubmit={formik.handleSubmit}>
                  ...
                  <div className={styles.formLine}>
                    <div className={styles.firstInput}>
                      <FormControl
                        control="input"
                        label="Current Company Turnover(per month in AED)"
                        name="currentCompanyTernover"
                        onChange={(val: string) => handleChange(val, 'currentCompanyTernover', formik)}
                        isInvalid={Boolean(
                          formik.errors.currentCompanyTernover
                            && formik.touched.currentCompanyTernover,
                        )}
                      />
                    </div>
                    <div className={styles.secondInput}>
                  ...
                  <div className={styles.formLine}>
                    <div className={styles.firstInput}>
                      <FormControl
                        ...
                        list={List['PROP-TYPE']}
                        label="Property type*"
                        onChange={(val: string) => handleChange(val[0], 'property_type', formik)}
                        isInvalid={Boolean(
                    ...
                    <div className={styles.secondInput}>
                      <FormControl
                        ...
                        label="Loan type*"
                        onChange={(val: string) => handleChange(val[0], 'loanTypeRes', formik)}
                        isInvalid={Boolean(
                          formik.errors.loanTypeRes && formik.touched.loanTypeRes,
                        )}
                      />
                    </div>
                  </div>
                  ...
                  <div className={styles.formLine}>
                    ...
                    <div className={styles.secondInput}>
                      <FormControl
                        ...
                        name="loanType"
                        control="select"
                        list={List['PURPOSE-LOAN']}
                        fontFamily="Graphik"
                        label="Loan type"
                        onChange={(val: string) => handleChange(val, 'loanType', formik)}
                        isInvalid={Boolean(
                  ...
                  <div className={styles.formLine}>
                    <div className={styles.firstInput}>
                      <FormControl
                        ...
                        onChange={(val: string) => handleChange(val[0], 'propertyLocation', formik)}
                        isInvalid={Boolean(
                  ...
                  <div style={{ paddingTop: '12px' }}>
                    <div style={{ padding: '18px' }}>
                      <h2 style={{ fontSize: 'small' }}>
                        <strong>Business Income (per month in AED)</strong>
                      </h2>
                      <RangeSlider
                        value={Number(formik.values.businessIncome)}
                        setValue={(val: number) => handleChange(String(val), 'businessIncome', formik)}
                        startRange={30000}
                        endRange={5000000}
                        moneyType="AED"
                      />
                  ...
                  <div style={{ paddingTop: '12px' }}>
                    <div style={{ padding: '18px' }}>
                      <h2 style={{ fontSize: 'small' }}>
                        <strong>Net Profit (per month in AED)</strong>
                      </h2>
                      <RangeSlider
                        value={Number(formik.values.netProfit)}
                        setValue={(val: number) => handleChange(String(val), 'netProfit', formik)}
                        startRange={30000}
                        endRange={5000000}
                        moneyType="AED"
                      />
...
export default MBBFApplicationDetailsPage;
