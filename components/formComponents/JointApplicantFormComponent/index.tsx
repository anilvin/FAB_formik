...
function JointApplicant({ onFormSubmit, initData }:Props) {
  ...
  const createWorkItemStructure = (data:any) => {
    const obj = {
      ...
      refMapper: '',
      taxMapper: '',
      connectedPartyType: 'Joint Applicant / Guarantor',
      connectedPartyCIF: '',
              ...
              <div className={styles.gridContainer}>
                ...
                <div>
                  <FormControl
                    ...
                    onBlur={() => { console.log('Officephno onblur'); }}
              ...
              <div className={styles.gridContainer}>
                <div>
                  <FormControl
                    control="fastselect"
                    onChange={(val: string[]) => {
                      handleChange(val[0], 'ReferenceDetails.referenceType', formik);
                    }}
                    label="Reference Type"
                    name="ReferenceDetails.referenceType"
                    list={List['IDENTIFIER-TYPE']}
                    isInvalid={Boolean(
                      formik.errors?.ReferenceDetails?.referenceType
                      && formik.touched?.ReferenceDetails?.referenceType,
                    )}
                  />
                </div>
                <div>
                  <FormControl
                    ...
                    onChange={(val: any) => handleChange(val, 'ReferenceDetails.referenceMobileNumber', formik)}
                    onChangeSelect={(val: string[]) => {
                      setHomePNCountrycode(val[0]);
                      console.log(homePNCountrycode);
                    }}
                    ...
                    name="ReferenceDetails.referenceMobileNumber"
                    isInvalid={Boolean(
                      formik.errors?.ReferenceDetails?.referenceMobileNumber
                      && formik.touched?.ReferenceDetails?.referenceMobileNumber,
                    )}
                  />
                </div>
                <div>
                  <FormControl
                    control="input"
                    onChange={(val:any) => handleChange(val, 'ReferenceDetails.referenceEmail', formik)}
                    label="Reference Email"
                    name="ReferenceDetails.referenceEmail"
                    isInvalid={Boolean(
                      formik.errors.ReferenceDetails?.referenceEmail
                      && formik.touched.ReferenceDetails?.referenceEmail,
                    )}
                  />
                </div>
                <div>
                  <FormControl
                    control="fastselect"
                    onChange={(val:any) => handleChange(val[0], 'ReferenceDetails.relationshipwithKcp', formik)}
                    label="Relationship with KCP"
                    name="ReferenceDetails.relationshipwithKcp"
                    list={List['IDENTIFIER-TYPE']}
                    isInvalid={Boolean(
                      formik.errors.ReferenceDetails?.relationshipwithKcp
                      && formik.touched.ReferenceDetails?.relationshipwithKcp,
                    )}
                  />
                </div>
                <div>
                  <FormControl
                    control="input"
                    label="Telechecking with Contact Person (Home, Office, Reference)"
                    name="ReferenceDetails.telecheckingwithContactPerson"
                    onChange={(val: string) => handleChange(val, 'ReferenceDetails.telecheckingwithContactPerson', formik)}
                    isInvalid={Boolean(
                      formik.errors.ReferenceDetails?.telecheckingwithContactPerson
                      && formik.touched.ReferenceDetails?.telecheckingwithContactPerson,
                    )}
                  />
                </div>
              </div>
